...
const Contact = () => {
    ...
    const handleSubmit = (e) => {
        ...
        emailjs.send("service_t94tj3n", "template_tybz4mm", 
            {
               from_name: form.name,
               to_name: 'Mathieu', 
               from_email: form.email,
               to_email: 'mathieu.rl.baba@gmail.com',
        ...
        .then(() => {
            setLoading(false);
            alert('Thank you, i will get back soon as possible !');
            ...
            <motion.div variants={slideIn('left', 'tween', 0.2, 1)} className="flex-[0.75] bg-black-100 p-8 rounded-2xl">
                ...
                <form ref={formRef} onSubmit={handleSubmit} className="mt-12 flex flex-col gap-8">
                    ...
                    <label className="flex flex-col">
                        ...
                        <input type="text" name="email" value={form.email} onChange={handleChange} placeholder="What's your email ?" className="bg-tertiary py-4 px-6 placeholder:text-secondary text-white rounded-lg outlined-none border-none font-medium"/>
                    </label>
